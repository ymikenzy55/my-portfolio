...
import { Mail, Linkedin, Github, Phone, Link, Instagram, Facebook, Twitter, Youtube, Dribbble, Globe } from 'lucide-react'
...
export default function Navigation({ onNavigate }: NavigationProps) {
  ...
  const [socialIcons, setSocialIcons] = useState<{ name: string; href: string; icon: React.ReactNode }[]>([])
  ...
  useEffect(() => {
    ...
    loadSocialLinks()
    const interval = setInterval(loadSocialLinks, 3000)
